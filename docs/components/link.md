...
title: Link
category: Components
url: https://design.ignitionapp.com/25ddf264c/p/4932085
scraped: 2025-11-16T03:28:37.386Z
---
...
### Variants
(No specific variants other than styling options were mentioned in the provided content.)
...
## Accessibility
(No specific accessibility considerations were explicitly mentioned in the provided content beyond the inherent interactive nature indicated by color.)

## Code Examples
(No code examples were provided in the source content.)

## Spacing/Sizing
(Specific spacing and sizing values were not explicitly provided, but sizing is implicitly handled by the "Styling Options" which align with predefined typographic scales.)
