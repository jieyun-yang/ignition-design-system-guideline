...
title: Combo button
category: Components
url: https://design.ignitionapp.com/25ddf264c/p/5042441
scraped: 2025-11-16T03:29:07.361Z
---
...
#### Default action
*(Details about the interaction for the default action are not provided in the extracted content.)*

#### Opening the menu
*(Details about how to open the menu are not provided in the extracted content.)*

#### Closing the menu
*(Details about how to close the menu are not provided in the extracted content.)*

### Spacing and Sizing
#### Sizing
*(Specific sizing guidelines are not provided in the extracted content.)*

### Accessibility
*(Specific accessibility considerations are not provided in the extracted content.)*

### Code Examples
*(No code examples are provided in the extracted content.)*

### Related Components
- [Menu button](link-to-menu-button-guideline)
```