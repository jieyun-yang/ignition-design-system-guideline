...
title: Signature
category: Components
url: https://design.ignitionapp.com/25ddf264c/p/4940590
scraped: 2025-11-16T03:17:46.692Z
---
...
### States
*   No specific states (e.g., hover, active, disabled) are described in the provided content.

### Interactions
*   No specific interaction patterns (e.g., click, focus, input validation) are described in the provided content.

### Styling
*   No specific styling guidelines (beyond font selection) are described in the provided content.

## Variants
*   No distinct visual or functional variants of the Signature component are described in the provided content.
