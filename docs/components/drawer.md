...
title: Drawer
category: Components
url: https://design.ignitionapp.com/25ddf264c/p/5013978
scraped: 2025-11-16T03:16:20.496Z
---
...
*   **Action Bar Guidelines**:
    ...
    *   *Note*: A ticket exists to update all actions buttons: `https://ignitionapp.atlassian.net/browse/UE-168`
*   **Header Guidelines**:
...
*   **Tabs Guidelines**:
    ...
    *   *Note*: A ticket exists to update header to display tabs, rather than radio group buttons: `https://ignitionapp.atlassian.net/browse/UE-163`
...
*   **Don't** use a drawer for simple tasks. Consider an [Input modal](#related-components) instead.
...
*   [Modal](#) (General modal component, applicable for summary or complex tasks)
*   [Input modal](#) (Consider for simple tasks)
```