...
title: Select
category: Components
url: https://design.ignitionapp.com/25ddf264c/p/2979782
scraped: 2025-11-16T03:08:48.428Z
---
...
*   To improve usability, checkboxes should be considered for options within the menu (refer to UE board ticket for further details).
...
*   A general clear 'X' icon may also be displayed after selections, allowing removal of the entire selection. Clicking this 'X' removes all selections.
