...
title: Alert
category: Components
url: https://design.ignitionapp.com/25ddf264c/p/2978049
scraped: 2025-11-16T03:25:51.746Z
---
...
### Do
*   If the user needs to take action, use an inline link. (TBC)
*   Display one alert at one time. Consider the urgency and context when choosing which alert to display.

### Don't
*   Avoid using buttons for actions within alerts. (TBC)
*   Avoid displaying multiple alerts at one time.

## Accessibility
Accessibility considerations for this component are not explicitly detailed in the current guidelines. (TBC)
