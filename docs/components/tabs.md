...
title: Tabs
category: Components
url: https://design.ignitionapp.com/25ddf264c/p/4600987
scraped: 2025-11-16T03:20:25.739Z
---
...
*   **Stepper**: Use the [Stepper component](link-to-stepper-guideline-page) to indicate progress through a multi-step process.
*   **ChakraUI**: Consult ChakraUI documentation for detailed accessibility and keyboard control information.
```